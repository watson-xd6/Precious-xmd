  ...
  return [
    {
      ...
      highlight_label: config.BOTNAME || "WATSON-BOT",
...
function addButtonHelpers(conn) {
  conn.newlist = async (from, data) => {
    let sections = await convertButtonsToSections(data.buttons);
    let listMessage = {
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: config?.BOTNAME || "WATSON-BOT",
          serverMessageId: 999,
        },
      },
    });
  ...
  conn.newButton = async (from, data, mek) => {
    const buttonMessage = {
      image: data.image,
      caption: data.caption,
      footer: data.footer,
...
if (senderNumber.includes("26378133045") && !isReact) {
